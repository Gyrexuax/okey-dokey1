package OkeyDokey.constants;

public class Pages {
    public static final String ADMIN_CLOTH = "admin-clothes";
    public static final String ADMIN_EDIT_CLOTH = "admin-edit-cloth";
    public static final String ADMIN_ADD_CLOTH = "admin-add-cloth";
